...
describe('ModalProvider', () => {
  test('should render children and provide modal context', () => {
    const ChildComponent = () => {
      ...
      return (
        <>
          <button onClick={() => openModal({ body: <div>Modal Content</div> })}>Open Modal</button>
  ...
  test('should handle custom onClose', () => {
    ...
    const ChildComponent = () => {
      ...
      return (
        <>
          <button onClick={() => openModal({ body: <div>Modal Content</div>, onClose: onCloseMock })}>Open Modal</button>
          <button onClick={closeModal}>Close Modal</button>
        </>
      )
    };
